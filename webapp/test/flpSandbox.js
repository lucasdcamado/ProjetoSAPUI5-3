		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zmmsapzmm002-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmmsapzmm002-display": {
								"semanticObject": "zmmsapzmm002",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmm.sap.zmm002",
									"url": sap.ui.require.toUrl("zmm/sap/zmm002")
								}
							}
						}
					}
